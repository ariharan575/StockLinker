...
export default function SettingsPage() {
      ...
      return (
        ...
        >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            >
              <Moon className="mx-auto text-sky-400" />
            ...
            >
              <Sun className="mx-auto text-pink-400" />
  ...
  return (
    ...
    >
            ...
            <div className="flex items-center gap-4">
              <div
                className="
                  ...
                  to-rose-500
                  text-white
                  shadow-[0_25px_60px_rgba(236,72,153,0.35)]
                "
              >
                <Store size={24} />
              </div>
      ...
      <div className="relative flex px-4 pb-8 md:px-6">
        {/* SIDEBAR */}
            ...
            >
              <div>
                ...
                >
                  ...
                  business settings system for
                  StockLinker marketplace and
