            ...
            <div className="mt-10 flex items-center gap-4">
              {[FaGithub, FaLinkedin, Mail].map((Icon, i) => (
                <motion.a
                  ...
                  className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] transition-all hover:bg-white/90 hover:text-black"
                >
                  <Icon size={20} />
                </motion.a>
              ))}
