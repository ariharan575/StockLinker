...
const StepCard = ({ step, isEven, shouldReduceMotion }) => {
  ...
  return (
    <motion.div
      ...
      className={`group relative w-full rounded-2xl p-6 md:p-8 transition-all duration-500
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 mb-4">
        ...
        <div className={`p-2.5 rounded-xl bg-gradient-to-br ${step.highlightColor} bg-opacity-10 text-white shadow-sm group-hover:scale-110 transition-transform duration-300`}>
      ...
      {step.tags && (
        <div className="flex flex-wrap gap-2 pt-2 border-t border-zinc-100 dark:border-zinc-800/60">
          {step.tags.map((tag) => (
            <span
              key={tag}
              className="inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-md bg-zinc-100/80 dark:bg-zinc-800/50 text-zinc-700 dark:text-zinc-300 border border-zinc-200/60 dark:border-zinc-700/40"
            >
...
export default function HowStockLinkerWorks() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative w-full py-14 md:py-18 bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 overflow-hidden transition-colors duration-300"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 md:mb-28">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200/60 dark:border-indigo-800/50 text-indigo-600 dark:text-indigo-400 text-xs font-semibold tracking-wide uppercase mb-4"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl text-zinc-600 dark:text-zinc-400 font-normal leading-relaxed"
          >
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="absolute left-6 md:left-1/2 top-0 w-0.5 bg-gradient-to-b from-blue-500 via-indigo-500 to-amber-500 -translate-x-1/2 shadow-[0_0_12px_rgba(99,102,241,0.6)] origin-top z-0"
            aria-hidden="true"
          />
