...
export default function SectionHead({ title, sub, action, actionPath }) {
  ...
  return (
    <div className="flex items-center justify-between ps-2 mb-1.5 sm:mb-3">
      <div>
        ...
        {sub && (
          <p className="hidden sm:block font-medium text-slate-700 text-sm mt-1" style={{fontFamily: FONT_BODY }}>
            {sub}
          </p>
        )}
      </div>
