...
export function EditableDetailItem({ label, value, isEditing, onChange, fieldKey }) {
  if (isEditing) {
    return (
      <div className="rounded-2xl border border-sky-300 bg-sky-50 p-4 transition-all duration-300 h-full">
