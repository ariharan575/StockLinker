...
const getPremiumIconStyle = (index) => {
  const styles = [
    "bg-slate-900 text-white border-transparent shadow-sm", // Black
    "bg-pink-50 text-pink-600 border-pink-100", // Soft Pink
    "bg-slate-50 text-slate-700 border-slate-200", // Light Grey
    "bg-zinc-100 text-zinc-900 border-zinc-200", // Zinc/Grey
    "bg-gradient-to-br from-pink-500 to-rose-500 text-white border-transparent shadow-sm", // Pink Gradient
    "bg-slate-800 text-pink-50 border-transparent shadow-sm" // Dark Slate
  ];
...
export default function WhyStockLinkers() {
  return (
    // Explicitly hidden on mobile (< 768px), visible on md+ as requested
